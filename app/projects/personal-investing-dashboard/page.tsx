...
export default function PersonalInvestingDashboardProject() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(63,140,255,0.15),transparent_55%),_var(--page-gradient)] text-foreground selection:bg-primary/20">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-16 lg:px-8">
        <div className="project-hero mb-12 flex flex-col gap-6 p-10">
        ...
        <section className="mb-12 grid gap-8 lg:grid-cols-[1.5fr_1fr]">
          <article className="project-section mb-12 p-10">
          ...
          <aside className="project-section mb-12 p-10">
        ...
        <section className="project-section mb-12 p-8">
        ...
        <section className="project-section mb-12 p-10">
